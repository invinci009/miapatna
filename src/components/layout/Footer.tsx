    ...
    return (
        <footer className="bg-gradient-to-br from-neutral via-neutral-focus to-neutral text-neutral-content relative overflow-hidden">
            ...
            <div className="border-t border-white/10">
                <div className="container mx-auto px-4 md:px-8 lg:px-16 py-6 relative z-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/60">
                        ...
                        <p className="flex items-center gap-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-secondary hover:text-secondary-300 font-semibold transition-colors"
                            >
                                Ignius Studios
                            </a>
                        </p>
